...
var KTSuratsEditSurat = function () {
    const id_surat = document.getElementById("id_surat").value;
    const modalElement = document.getElementById("kt_modal_edit_surat-" + id_surat);
    const formElement = modalElement && modalElement.querySelector("#kt_modal_edit_surat_form");
