					...
					<div class="card-header border-0 pt-6">
						...
						<div class="card-toolbar">
							...
							<div class="d-flex justify-content-end align-items-center d-none" data-kt-warga-table-toolbar="selected">
								...
								<form id="delete-selected-form" action="{{ route('warga-admin.deleteSelected', ['rt' => $rtNumber]) }}" method="POST">
									...
									<td class="text-end">
										...
										<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
											...
											<div class="menu-item px-3">
												...
												<form id="delete-form-{{ $warga->id_warga }}" action="{{ route('warga-admin.destroy', ['rt' => $rtNumber, 'id' => $warga->id_warga]) }}" method="POST" style="display: none;">
													@csrf
													@method('DELETE')
												</form>
											</div>
