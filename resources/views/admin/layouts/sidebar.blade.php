        ...
        <div id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false"
            ...
            <div class="menu-item menu-accordion">
                ...
                <a class="menu-link {{ $activeMenu == 'dashboard' ? 'active' : '' }}"
                    href="{{ route('admin.index', ['rt' => $rtNumber]) }}">
            ...
            <div class="menu-item menu-accordion">
                <!-- Begin: Menu link -->
                <a class="menu-link {{ $activeMenu == 'datakk' ? 'active' : '' }}"
                    href="{{ route('kk-admin.index', ['rt' => $rtNumber]) }}">
                    <span class="menu-icon">
            ...
            <div class="menu-item menu-accordion">
                <!-- Begin: Menu link -->
                <a class="menu-link {{ $activeMenu == 'warga' ? 'active' : '' }}"
                    href="{{ route('warga-admin.index', ['rt' => $rtNumber]) }}">
                    <span class="menu-icon">
                        @if ($activeMenu == 'warga')
