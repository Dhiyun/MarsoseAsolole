                            ...
                            <div class="card-toolbar">
                                ...
                                <div class="d-flex justify-content-end align-items-center d-none"
                                    ...
                                    <form id="delete-selected-form"
                                        action="{{ route('kkwarga-admin.deleteSelected', ['rt' => $rtNumber]) }}"
                                        method="POST">
                                            ...
                                            <td class="text-end">
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <a href="{{ route('kkwarga-admin.show', ['rt' => $rtNumber, 'id_kk' => $warga->kk->id_kk, 'id_warga' => $warga->id_warga]) }}"
                                                    ...
                                                    <div class="menu-item px-3">
                                                        ...
                                                        <form id="delete-form-{{ $warga->id_warga }}"
                                                            action="{{ route('kkwarga-admin.destroy', ['rt' => $rtNumber, 'id_warga' => $warga->id_warga]) }}"
