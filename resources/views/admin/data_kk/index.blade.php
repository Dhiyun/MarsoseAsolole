                            ...
                            <div class="card-toolbar">
                                ...
                                <div class="d-flex justify-content-end align-items-center d-none"
                                    ...
                                    <form id="delete-selected-form"
                                        action="{{ route('kk-admin.deleteSelected', ['rt' => $rtNumber]) }}" method="POST">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="form-check form-check-sm form-check-custom form-check-solid">
                                                    <input value="{{ $kk->id_kk }}" class="form-check-input"
                                                        type="checkbox" data-kt-kk-table-filter="checkbox" />
                                                </div>
                                            </td>
                                            <td>{{ $kk->id_kk }}</td>
                                            <td>{{ $kk->no_kk }}</td>
                                            ...
                                            <td class="text-end">
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <a href="{{ route('kk-admin.show', ['id' => $kk->id_kk, 'rt' => $rtNumber]) }}"
                                                    ...
                                                    <div class="menu-item px-3">
                                                        ...
                                                        <form id="delete-form-{{ $kk->id_kk }}"
                                                            action="{{ route('kk-admin.destroy', ['id' => $kk->id_kk, 'rt' => $rtNumber]) }}"
