            ...
            <div class="card mt-0 h-100 shadow keluhan" style="background-image: url('assets/media/logos/rhone.svg'); ">
                <div class="card-header align-items-center border-0 mt-4">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="mb-2 text-dark pt-10"
                            style="font-size: 24px; padding-bottom: 12px; font-weight: bold;">Laporkan Keluhan</span>
                        <span class="text-muted fw-semibold" style="font-size: 16px;">Anda dapat melaporkan segala
                            bentuk</span>
                        <span class="text-muted fw-semibold" style="font-size: 16px;">keluhan anda di lingkungan
                            marsose</span>
                        <span class="text-muted fw-semibold" style="font-size: 16px;">RW 03. Segera laporkan!</span>
                    </h3>
                </div>
                <div class="card-body pt-5">
                    <button class="btn laporan" onclick="window.location.href='{{ route('user-laporan.create') }}'">Buat
                        Laporan</button>
                </div>
            </div>
        </div>
                ...
                <div class="card-header align-items-center border-0 mt-4" style="width: 100%; text-align: center;">
                    <h3 class="card-title align-items-center flex-column">
                        ...
                        <button class="btn btn-sm c-laporan"
                            onclick="window.location.href='{{ route('user-laporan.history') }}'">Laporan Anda</button>
                    </h3>
                </div>
            </div>
        </div>
                        ...
                        <div class="card h-100 shadow card-rounded" style="border-radius: 1.5em">
                            <a class="d-block overlay" data-fslightbox="lightbox-hot-sales"
                                ...
                                <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px"
                                    style="background-image:url('{{ asset($laporan->gambar) }}')">
                                    <span
                            ...
                            <div class="card-body m-0">
                                <h5 class="fs-4 text-dark fw-bold text-hover-primary text-dark lh-base">
                                    {{ $laporan->judul }}</h5>
                                <p class="card-text fw-semibold text-gray-600">{{ $laporan->keterangan }}</p>
                                <div class="fs-6 fw-bold">
                                    <span class="text-muted fw-light text-gray-800 mt-1">Pelapor: </span><span
                                        class="fw-bold">{{ $laporan->warga->nama }} | <span
                                            class="fw-normal">{{ $laporan->created_at->format('d M Y') }}</span></span>
                                    <span
