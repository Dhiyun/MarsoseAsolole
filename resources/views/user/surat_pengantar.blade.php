...
<div class="row">
    ...
    <div class="card pt-2 col-md-9 banner-surat shadow"
        style="background-image: url('assets/media/img/banner-sp.png');">
            ...
            <div class="tab-content surat-content" data-handbook="surat_pengantar" id="v-pills-tabContent">
                <div class="tab-pane show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                    ...
                    <p class="mt-2" style="line-height: 32px; font-size: 16px;">
                        Surat Pengantar adalah dokumen yang digunakan untuk mengirimkan permohonan atau merekomendasikan
                        seseorang atau sesuatu kepada pihak lain. Tujuannya adalah untuk memberikan pengantar formal dan
                        menjelaskan maksud dari permohonan atau rekomendasi yang disampaikan. Surat ini mencakup
                        identitas pengirim, penerima, serta informasi yang relevan terkait dengan permohonan atau
                    ...
                    <table style="border-collapse: separate; border-spacing:0 20px; font-size: 16px;">
                        ...
                        <tr>
                            <td><img src="assets/media/icons/point-alur.svg"
                                    style="height: 20px; width: 20px; margin-right: 20px;"></td>
                            <td>Surat Pengantar RT dan RW selesai dan dapat digunakan untuk pengurusan administrasi
                                selanjutnya.</td>
                        </tr>
                    </table>
                </div>
                ...
                <ul class="listings__grid" style="padding-left:5px;">
                    ...
                    @endforeach
                    {{-- <li class="card jenis-surat">
                        <img src="assets/media/icons/icon-spengantar.svg" alt="" class="card__logo"
