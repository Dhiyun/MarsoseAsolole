        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                ...
                <form method="POST" action="{{ route('level.update', ['id' => $lvl->id_level]) }}" class="form">
                    ...
                    @method('PUT')
                    <!--begin::Scroll-->
                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_edit_level_scroll"
                        data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}"
                        data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_edit_level_header"
                        data-kt-scroll-wrappers="#kt_modal_edit_level_scroll" data-kt-scroll-offset="300px">
                        <!--begin::Input group-->
