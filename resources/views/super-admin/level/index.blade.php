                        ...
                        <div class="card-header border-0 pt-6">
                            ...
                            <div class="card-title">
                                ...
                                <div class="d-flex align-items-center position-relative my-1">
                                    ...
                                    <input type="text" data-kt-level-table-filter="search"
                                        class="form-control form-control-solid w-250px ps-13" placeholder="Search Level" />
                                </div>
                                <!--end::Search-->
                            </div>
                            <!--begin::Card title-->
                            ...
                            <div class="card-toolbar">
                                ...
                                <div class="d-flex justify-content-end align-items-center d-none"
                                    ...
                                    <form id="delete-selected-form" action="{{ route('level.deleteSelected') }}"
                                        method="POST">
                                        ...
                                        <button type="submit" class="btn btn-danger"
                                            data-kt-level-table-select="delete_selected">Delete Selected</button>
                                    </form>
                                </div>
                                <!--end::Group actions-->
                                        ...
                                        <th class="w-10px pe-2">
                                            <div class="form-check form-check-sm form-check-custom form-check-solid me-3">
                                                <input class="form-check-input" type="checkbox" data-kt-check="true"
                                                    data-kt-check-target="#kt_table_level .form-check-input" />
                                            </div>
                                        </th>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="form-check form-check-sm form-check-custom form-check-solid">
                                                    <input value="{{ $lvl->id_level }}" class="form-check-input"
                                                        type="checkbox" data-kt-level-table-filter="checkbox" />
                                                </div>
                                            </td>
                                            <td>{{ $lvl->id_level }}</td>
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <a href="#"data-bs-toggle="modal"
                                                            data-bs-target="#kt_modal_edit_level-{{ $lvl->id_level }}"
                                                    ...
                                                    <div class="menu-item px-3">
                                                        ...
                                                        <form id="delete-form-{{ $lvl->id_level }}"
                                                            action="{{ url('/level/destroy/' . $lvl->id_level) }}"
