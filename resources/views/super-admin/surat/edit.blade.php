    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                <!--begin::Form-->
                <form method="POST" id="kt_modal_edit_surat_form" class="form"
                    action="{{ route('surat.update', ['id' => $surat->id_surat]) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <!--begin::Scroll-->
                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_edit_surat_scroll"
                        data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}"
                        data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_edit_surat_header"
                        data-kt-scroll-wrappers="#kt_modal_edit_surat_scroll" data-kt-scroll-offset="300px">
                        <!-- Jenis Surat -->
                        <div class="fv-row mb-7">
                            ...
                            <select id="jenis_surat" name="jenis_surat"
                                ...
                                <option value="Surat Pengantar"
                                    {{ $surat->jenis_surat == 'Surat Pengantar' ? 'selected' : '' }}>Surat Pengantar
                                </option>
                                <option value="Surat Keterangan"
                                    {{ $surat->jenis_surat == 'Surat Keterangan' ? 'selected' : '' }}>Surat Keterangan
                                </option>
                                <option value="Surat Undangan"
                                    {{ $surat->jenis_surat == 'Surat Undangan' ? 'selected' : '' }}>Surat Undangan
                                </option>
                                <option value="Surat Pemberitahuan"
                                    {{ $surat->jenis_surat == 'Surat Pemberitahuan' ? 'selected' : '' }}>Surat
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <input type="text" id="nama_surat" name="nama_surat"
                                class="form-control form-control-solid mb-3 mb-lg-0" value="{{ $surat->nama_surat }}"
                                required />
                        </div>
                        <!-- Upload File -->
                        <div class="fv-row mb-7">
                            ...
                            <input type="file" accept=".pdf,.doc,.docx" id="file_surat" name="file_surat"
                                class="form-control form-control-solid mb-3 mb-lg-0" value="{{ old('file_surat') }}" />
                        </div>
                    </div>
                    <!--end::Scroll-->
                    <!--begin::Actions-->
