                        ...
                        <div class="card-header border-0 pt-6">
                            ...
                            <div class="card-title">
                                ...
                                <div class="d-flex align-items-center position-relative my-1">
                                    ...
                                    <input type="text" data-kt-laporan-table-filter="search"
                                        class="form-control form-control-solid w-250px ps-13"
                                        placeholder="Search Laporan Pengaduan" />
                                </div>
                                <!--end::Search-->
                            </div>
                            <!--begin::Card title-->
                            ...
                            <div class="card-toolbar">
                                ...
                                <div class="d-flex justify-content-end" data-kt-laporan-table-toolbar="base">
                                    ...
                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                        data-bs-target="#kt_modal_add_laporan">
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_laporan">
                                ...
                                <tbody class="text-gray-600 fw-semibold">
                                    ...
                                    @foreach ($laporansP as $lp)
                                        <tr>
                                            <input id="id_laporan" type="hidden" value="{{ $lp->id_laporan }}"
                                            ...
                                            <td><img src="{{ asset($lp->gambar) }}" alt="Gambar Laporan"
                                                    style="max-width: 125px; max-height: 125px;"></td>
                                            <td>{{ $lp->keterangan }}</td>
                                            <td class="text-end">
                                                <button
                                                    class="btn btn-light btn-light-{{ $lp->status == 'diterima'
                                                        ? 'success'
                                                        : ($lp->status == 'ditolak'
                                                            ? 'danger'
                                                            : ($lp->status == 'diproses'
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                    ...
                                                    @if ($lp->status == 'diterima')
                                                        ...
                                                        <div class="menu-item px-3">
                                                            ...
                                                            <button type="button" class="btn btn-sm btn-warning w-100px"
                                                                data-bs-toggle="modal"
                                                                data-bs-target="#kt_modal_add_laporan-accept-{{ $lp->id_laporan }}">
