                                        ...
                                        <div class="table-responsive">
                                            <div class="row">
                                                <div class="col-7">
                                                    ...
                                                    <p class="text-muted text-sm"><b>Judul: </b> {{ $lp->judul }}</p>
                                                    <ul class="ml-4 mb-0 fa-ul text-muted">
                                                        <li class="small"><span class="fa-li"><i class="fas fa-calendar"></i></span> Tanggal Laporan: {{ $lp->created_at->format('l, d F Y') }}</li>
                                                        <li class="small"><span class="fa-li"><i class="fas fa-sticky-note"></i></span> Keterangan: {{ $lp->keterangan }}</li>
                                                    </ul>
                                                </div>
                                                <div class="col-5 text-center">
                                                    <img src="{{ asset($lp->gambar) }}" alt="Gambar Laporan" class="img-fluid">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
