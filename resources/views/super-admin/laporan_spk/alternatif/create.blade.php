    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                <!--begin::Form-->
                <form method="POST" id="kt_modal_add_alternatif_form" class="form" action="{{ route('alternatif.store') }}" enctype="multipart/form-data">
                    @csrf
                    <!--begin::Scroll-->
                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_alternatif_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_alternatif_header" data-kt-scroll-wrappers="#kt_modal_add_alternatif_scroll" data-kt-scroll-offset="300px">
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <input type="text" id="kode_alternatif" name="kode_alternatif" class="form-control form-control-solid mb-3 mb-lg-0" {{ old('kode_alternatif') }} required />
                        </div>
                        <!--begin::Input group-->
                        <div class="fv-row mb-7">
                            ...
                            <select name="id_laporan" data-control="select2" class="form-select form-select-solid form-select-lg" required>
                                ...
                                @foreach($juduls as $jdl)
                                    <option value="{{ $jdl->id_laporan }}" data-alternatif-nama="{{ $jdl->judul }}" {{ old('id_laporan') == $jdl->id_laporan ? 'selected' : '' }}>{{ $jdl->judul }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
