					...
					<div class="card-header border-0 pt-6">
						...
						<div class="card-title">
							...
							<div class="d-flex align-items-center position-relative my-1">
								...
								<input type="text" data-kt-alternatif-table-filter="search" class="form-control form-control-solid w-250px ps-13" placeholder="Search Alternatif" />
							</div>
							<!--end::Search-->
						</div>
						<!--begin::Card title-->
						...
						<div class="card-toolbar">
							...
							<div class="d-flex justify-content-end align-items-center d-none" data-kt-alternatif-table-toolbar="selected">
								...
								<form id="delete-selected-form" action="{{ route('alternatif.deleteSelected') }}" method="POST">
									...
									<button type="submit" class="btn btn-danger" data-kt-alternatif-table-select="delete_selected">Delete Selected</button>
								</form>
							</div>
							<!--end::Group actions-->
								...
								<tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
									<th class="w-10px pe-2">
										<div class="form-check form-check-sm form-check-custom form-check-solid me-3">
											<input class="form-check-input" type="checkbox" data-kt-check="true" data-kt-check-target="#kt_table_alternatif .form-check-input" />
										</div>
									</th>
								...
								<tr>
									<td>
										<div class="form-check form-check-sm form-check-custom form-check-solid">
											<input value="{{ $alternatif->id_alternatif }}" class="form-check-input" type="checkbox" data-kt-alternatif-table-filter="checkbox" />
										</div>
									</td>
									...
									<td class="text-end">
										...
										<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
											...
											<div class="menu-item px-3">
												<a href="#" data-bs-toggle="modal" data-bs-target="#kt_modal_edit_alternatif-{{ $alternatif->id_alternatif }}" class="menu-link px-3"><i
													class="ki-outline ki-pencil fs-6"></i>-Edit</a>
											</div>
											<!-- End::Menu item -->
											<!-- Begin::Menu item -->
											<div class="menu-item px-3">
												<form id="deleteForm_{{ $alternatif->id_alternatif }}" action="{{ route('alternatif.destroy', ['id' => $alternatif->id_alternatif]) }}" method="POST" style="display: none;">
													@csrf
													@method('DELETE')
												</form>
												<a href="#" class="menu-link px-3" onclick="event.preventDefault(); document.getElementById('deleteForm_{{ $alternatif->id_alternatif }}').submit();">
