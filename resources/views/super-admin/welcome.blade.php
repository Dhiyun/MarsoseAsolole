				...
				<div class="col-12 col-sm-4 col-xl-4 mb-4 d-flex flex-column">
					<div class="card h-100 shadow-sm border-gradient border-gradient-yellow">
						<div class="card-body">
							<header class="d-flex justify-content-between align-items-start mb-2">
								<!-- Icon -->
								<img alt="Icon" src="assets/media/icons/icon-01.svg" width="32" height="32" />
							</header>
							<h2 class="d-flex align-items-center text-dark mb-5">Jumlah Warga</h2>
							...
							<div class="d-flex align-items-start">
								...
								<div class="badge bg-yellow-500">-</div>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-12 col-sm-4 col-xl-4 mb-4 d-flex flex-column">
					<div class="card h-100 shadow-sm border-gradient border-gradient-green">
						<div class="card-body">
							<header class="d-flex justify-content-between align-items-start mb-2">
								<!-- Icon -->
								<img alt="Icon" src="assets/media/icons/icon-03.svg" width="32" height="32" />
							</header>
