...
@section('title', 'Super Admin | Detail Data KK')
                        ...
                        <div class="card-header border-0 pt-6">
                            ...
                            <div class="card-title">
                                ...
                                <div class="d-flex align-items-center position-relative my-1">
                                    ...
                                    <input type="text" data-kt-wargalokal-table-filter="search"
                                        class="form-control form-control-solid w-250px ps-13" placeholder="Search Nama" />
                                </div>
                                <!--end::Search-->
                            </div>
                            <!--End::Card title-->
                            ...
                            <div class="card-toolbar">
                                ...
                                <div class="d-flex justify-content-end" data-kt-wargalokal-table-toolbar="base">
                                    <!--begin::Add warga-->
                                    <button type="button" class="btn btn-primary" onclick="addWargaForm()"
                                        data-bs-target="#kt_modal_add_wargalokal">
                                ...
                                <div class="d-flex justify-content-end align-items-center d-none"
                                    data-kt-wargalokal-table-toolbar="selected">
                                    <div class="fw-bold me-5">
                                        <span class="me-2"
                                            data-kt-wargalokal-table-select="selected_count"></span>Selected
                                    </div>
                                    <form id="delete-selected-form" action="{{ route('kkwarga.deleteSelected') }}"
                                        method="POST">
                                        ...
                                        <button type="submit" class="btn btn-danger"
                                            data-kt-wargalokal-table-select="delete_selected">Delete Selected</button>
                                    </form>
                                </div>
                                <!--end::Group actions-->
                            </div>
                                        ...
                                        <th class="w-10px pe-2">
                                            <div class="form-check form-check-sm form-check-custom form-check-solid me-3">
                                                <input class="form-check-input" type="checkbox" data-kt-check="true"
                                                    data-kt-check-target="#kt_table_wargalokal .form-check-input" />
                                            </div>
                                        </th>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="form-check form-check-sm form-check-custom form-check-solid">
                                                    <input id="id_warga_lokal" value="{{ $warga->id_warga }}"
                                            ...
                                            <td class="text-end">
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <a href="{{ route('kkwarga.show', ['id_kk' => $warga->kk->id_kk, 'id_warga' => $warga->id_warga]) }}"
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <a href="#" data-bs-toggle="modal"
                                                            data-bs-target="#kt_modal_edit_wargalokal-{{ $warga->id_warga }}"
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <a href="#" class="menu-link px-3"
                                                            data-kt-wargalokal-table-filter="delete_row"
                                                            onclick="event.preventDefault(); handleRowDeletion(event);">
                                                            Delete
                                                        </a>
                                                        <form id="delete-form-{{ $warga->id_warga }}"
                                                            action="{{ route('kkwarga.destroy', ['id_warga' => $warga->id_warga, 'id_kk' => $kk->id_kk]) }}"
