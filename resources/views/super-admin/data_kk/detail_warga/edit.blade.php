    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                <!--begin::Form-->
                <form method="POST" id="kt_modal_edit_wargalokal_form" class="form"
                    action="{{ route('kkwarga.update', ['id_kk' => $kk->id_kk, 'id_warga' => $warga->id_warga]) }}">
                    @csrf
                    @method('PUT')
                    <!--begin::Scroll-->
                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_edit_wargalokal_scroll"
                    ...
                    <div class="text-center pt-15">
                        <button type="submit" class="btn btn-primary btn-sm"
                            data-kt-wargalokal-modal-action="submit">
