                        ...
                        <div class="menu-content d-flex align-items-center px-3">
                            ...
                            <div class="d-flex flex-column">
                                <div class="fw-bold d-flex align-items-center fs-5">SuperAdmin
                                    <span class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2">RW 3</span>
                                </div>
                                <div class="fw-semibold text-muted text-hover-primary fs-6">Nama:
                                    {{ Auth::user()->warga->nama }}</div>
                            </div>
                            <!--end::Username-->
                        </div>
                    </div>
