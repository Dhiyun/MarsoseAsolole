...
<div class="modal fade" id="kt_modal_edit_detail_kriteria-{{ $detail->id_detail_kriteria }}" tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            <!--begin::Modal header-->
            <div class="modal-header" id="kt_modal_edit_detail_kriteria_header">
                <!--begin::Modal title-->
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                <!--begin::Form-->
                <form method="POST" id="kt_modal_edit_detail_kriteria_form" class="form"
                    action="{{ route('detail_kriteria.update', ['id' => $detail->id_detail_kriteria]) }}">
                    @csrf
                    @method('PUT')
                    <!--begin::Scroll-->
